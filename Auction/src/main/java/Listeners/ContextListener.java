...
//            System.out.println(reader.getString("db.password"));
            ...
            SqlBidderAuctionDAO bidderAuctionDAO = new SqlBidderAuctionDAO(connection);
            ...
            servletContext.setAttribute(SqlBidderAuctionDAO.ATTRIBUTE_NAME, bidderAuctionDAO);
